...
type MarketplaceTemplate = TableRow<'marketplace_templates'>
type MarketplaceCategory = TableRow<'marketplace_categories'>
...
export class TemplateMarketplaceService {
  ...
  async publishTemplate(template: TableInsert<'marketplace_templates'>) {
    const { data, error } = await this.supabase
      .from('marketplace_templates')
      .insert({
        ...template,
  ...
  async updateTemplate(id: string, updates: TableUpdate<'marketplace_templates'>) {
    const { data, error } = await this.supabase
      .from('marketplace_templates')
      .update(updates)
      .eq('id', id)
  ...
  async downloadTemplate(marketplaceTemplateId: string, userId: string, organizationId: string) {
    ...
    const { data: marketplaceTemplate } = await this.supabase
      .from('marketplace_templates')
    ...
    const { data: download, error: downloadError } = await this.supabase
  ...
  async createRating(rating: TableInsert<'marketplace_ratings'>) {
    const { data, error } = await this.supabase
  ...
  async createCollection(collection: TableInsert<'marketplace_collections'>) {
    const { data, error } = await this.supabase
      .from('marketplace_collections')
      .insert(collection)
      .select()
  ...
  async createTransaction(transaction: TableInsert<'marketplace_transactions'>) {
    const { data, error } = await this.supabase
      .from('marketplace_transactions')
      .insert(transaction)
      .select()

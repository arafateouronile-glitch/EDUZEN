...
export async function updateAffiliateApplicationStatus(
  ...
  try {
    ...
    // Récupérer les infos de l'affilié avant la mise à jour pour l'email
...
<html>
  ...
  <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px;">
      <p>Bonjour <strong>${appFullName}</strong>,</p>
      <p>Nous sommes ravis de vous informer que votre candidature au programme affilié EduZen a été <strong>acceptée</strong>.</p>
      <div style="background: white; border-radius: 8px; padding: 20px; margin: 20px 0; border-left: 4px solid #10b981;">
        <p style="margin: 0;"><strong>Commission :</strong> 20 % sur chaque vente générée via votre lien de parrainage.</p>
      </div>
      <p>Pour découvrir vos prochaines étapes et accéder à votre tableau de bord affilié, cliquez sur le bouton ci-dessous :</p>
      <p style="text-align: center;">
        <a href="${appUrl}/affiliation" style="display: inline-block; background: #10b981; color: white; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 16px;">Découvrir mes prochaines étapes</a>
      </p>
      <p style="color: #6b7280; font-size: 13px;">Si le bouton ne fonctionne pas, copiez-collez ce lien dans votre navigateur : ${appUrl}/affiliation</p>
    </div>
    <div style="text-align: center; margin-top: 20px; color: #6b7280; font-size: 12px;">
      <p>EduZen — Plateforme de gestion de formations</p>
        ...
        await sendEmailViaResend({
          to: app.email,
          subject: 'Votre candidature affilié EduZen a été acceptée 🎉',
          html,
        })
...
<html>
  <head><meta charset="utf-8"></head>
  <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background: #f3f4f6; padding: 30px; border-radius: 8px 8px 0 0; text-align: center;">
      <h1 style="margin: 0; font-size: 24px; color: #374151;">Résultat de votre candidature</h1>
    </div>
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 8px 8px;">
      <p>Bonjour <strong>${appFullName}</strong>,</p>
      <p>Nous avons bien examiné votre candidature au programme affilié EduZen.</p>
      <p>Après étude de votre dossier, nous sommes au regret de vous informer que votre candidature n'a pas été retenue pour le moment.</p>
      <p>Nous vous remercions de l'intérêt que vous portez à EduZen et vous souhaitons bonne continuation.</p>
    </div>
    <div style="text-align: center; margin-top: 20px; color: #6b7280; font-size: 12px;">
      <p>EduZen — Plateforme de gestion de formations</p>
    </div>
        ...
        await sendEmailViaResend({
          to: app.email,
          subject: 'Candidature affilié EduZen',
          html,
        })
      }
    }

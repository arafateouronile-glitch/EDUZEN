...
const routeNames: Record<string, string> = {
  ...
  '/super-admin/affiliation': 'Affiliation',
  '/super-admin/affiliation/affiliates': 'Affiliés',
  '/super-admin/affiliation/campaigns': 'Campagnes',
  '/super-admin/affiliation/promo-codes': 'Codes Promo Affiliation',
  '/super-admin/affiliation/payouts': 'Paiements',
  '/super-admin/affiliation/preview': 'Aperçu Portail',

...
import { UserPlus, Settings, Users, BarChart3, ArrowRight, CheckCircle2 } from 'lucide-react'
...
export function HowItWorks() {
  ...
  return (
    <section id="comment-ca-marche" className="relative py-24 md:py-32 lg:py-40 overflow-hidden bg-gray-50">
      {/* Background pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(39,68,114,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(39,68,114,0.03)_1px,transparent_1px)] bg-[size:48px_48px]" />
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-gray-200 shadow-sm mb-6"
          >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className="relative bg-white rounded-3xl p-8 md:p-10 border-2 border-gray-100 hover:border-brand-blue/20 shadow-lg hover:shadow-xl transition-all duration-500">
                  {/* Step number badge */}
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    {/* Arrow to next step (only on desktop, not on last item) */}
                    {index < steps.length - 1 && (
                      <div className="hidden lg:flex items-center gap-2 text-gray-300 group-hover:text-brand-blue transition-colors duration-300">
          ...
          <motion.div
            ...
            className="hidden lg:block h-1 bg-gradient-to-r from-brand-blue via-brand-cyan to-brand-blue rounded-full mt-8 origin-left"
          />
        </div>
      </div>
    </section>

...
/** Retourne les classes CSS des variantes de bouton (pour composition avec Radix, etc.). */
export function buttonVariants({
  ...
  return cn(
    ...
    'active:scale-[0.98]',
    {
      ...
      'hover:-translate-y-0.5': variant === 'outline' || variant === 'ghost',
      'bg-brand-cyan text-white shadow-sm hover:shadow-md': variant === 'secondary',
      'hover:bg-brand-cyan-dark hover:-translate-y-0.5': variant === 'secondary',

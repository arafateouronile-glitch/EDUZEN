    ...
    return (
      <div className="space-y-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <h2 className="text-lg font-semibold text-red-800 mb-2">Organization ID manquant</h2>
          <p className="text-red-700 mb-4">Votre compte n'est pas associé à une organisation.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col space-y-4">
        <nav className="flex items-center text-sm text-gray-500">
          ...
          <span className="font-medium text-gray-900">Nouveau programme</span>
        </nav>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        {/* Floating Footer Action (optional, but user has a sticky footer in screenshot) */}
